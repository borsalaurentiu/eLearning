    ...
    <body>
        <div class="center">
            ...
            <img class="logo" src="../images/utcn_logo.png">
				<center>
				<?php if ( isset( $_GET['profesor'] ) && $_GET['profesor'] == 404 ): ?>
						<div style="font-size: 14px; color: red">Profesorul nu a fost adaugat!</div>
					<?php endif; ?><br>
				<?php if ( isset( $_GET['elev'] ) && $_GET['elev'] == 404 ): ?>
						<div style="font-size: 14px; color: red">Elevul nu a fost adaugat!</div>
					<?php endif; ?><br>
				<?php if ( isset( $_GET['profesor'] ) && $_GET['profesor'] == 403 ): ?>
						<div style="font-size: 14px; color: red">Profesorul nu a fost sters!</div>
					<?php endif; ?><br>
				<?php if ( isset( $_GET['elev'] ) && $_GET['elev'] == 403 ): ?>
						<div style="font-size: 14px; color: red">Elevul nu a fost sters!</div>
					<?php endif; ?><br>
				<a href="adaugaProfesor.php">adauga profesor</a><br>
				<a href="stergeProfesor.php">sterge profesor</a><br>
